package net.sf.ffmpeg_java.v52;
...
// avcodec.h
    ...
    public static final int LIBAVCODEC_VERSION_INT = ((52<<16)+(8<<8)+0);	// version this comes from
    public static final String LIBAVCODEC_VERSION  = "52.8.0";
