...
{
    public static String tmpDirName = System.getProperty("java.io.tmpdir");
    /**
     *  The prefix for the temp directory in the system temp directory
     */
    public static String TEMP_DIR_PREFIX = "tmp-mgr-";
    public static String INSTANCE_TMP_PREFIX = "";
    ...
    throws IOException
  {
	  synchronized (syncObject) {
	    ...
	    if (sTmpDir == null)
	    {
	      ...
	      File tmpDir = File.createTempFile(TEMP_DIR_PREFIX + INSTANCE_TMP_PREFIX, ".tmp",
	          new File(tmpDirName));
  ...
  public static void cleanupPreviousInstance() {
	  removeInstanceLocks();
	  cleanupTempFiles();
  }
  public static void removeInstanceLocks() {
		      ...
		      new FileFilter()
		      {
		        public boolean accept(File pathname)
		        {
		          return (pathname.isDirectory() &&
		              pathname.getName().startsWith(TEMP_DIR_PREFIX + INSTANCE_TMP_PREFIX));
		        }
		      };
